...
type PixiuClient interface {
	Bootstrap(ctx context.Context, in *PixiuRequest, opts ...grpc.CallOption) (*PixiuReply, error)
}
...
func (c *pixiuClient) Bootstrap(ctx context.Context, in *PixiuRequest, opts ...grpc.CallOption) (*PixiuReply, error) {
	out := new(PixiuReply)
	err := c.cc.Invoke(ctx, "/pixiu.Pixiu/Bootstrap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixiuServer interface {
	Bootstrap(context.Context, *PixiuRequest) (*PixiuReply, error)
...
func (UnimplementedPixiuServer) Bootstrap(context.Context, *PixiuRequest) (*PixiuReply, error) {
...
func _Pixiu_Bootstrap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PixiuRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PixiuServer).Bootstrap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pixiu.Pixiu/Bootstrap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixiuServer).Bootstrap(ctx, req.(*PixiuRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Pixiu_Bootstrap_Handler,
		},
	},
