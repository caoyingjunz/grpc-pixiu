...
var file_pbfile_cluster_proto_rawDesc = []byte{
	...
	0x22, 0x8f, 0x01, 0x0a, 0x0f, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4e,
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x43, 0x6c, 0x75, 0x73, 0x74,
	0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x22, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1c, 0x0a, 0x09, 0x53, 0x74,
	...
	0x6d, 0x65, 0x32, 0xce, 0x01, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x65, 0x72,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x41, 0x0a, 0x0c, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74,
...
var file_pbfile_cluster_proto_depIdxs = []int32{
	...
	0, // 2: service.CreateService.Check:input_type -> service.ClusterRequest
	0, // 3: service.CreateService.WriteFile:input_type -> service.ClusterRequest
	0, // 4: service.CreateService.Installation:input_type -> service.ClusterRequest
	1, // 5: service.CreateService.Check:output_type -> service.ClusterResponse
	1, // 6: service.CreateService.WriteFile:output_type -> service.ClusterResponse
	1, // 7: service.CreateService.Installation:output_type -> service.ClusterResponse
...
func (c *createServiceClient) Check(ctx context.Context, in *ClusterRequest, opts ...grpc.CallOption) (*ClusterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/service.CreateService/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *createServiceClient) WriteFile(ctx context.Context, in *ClusterRequest, opts ...grpc.CallOption) (*ClusterResponse, error) {
	out := new(ClusterResponse)
	err := c.cc.Invoke(ctx, "/service.CreateService/WriteFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *createServiceClient) Installation(ctx context.Context, in *ClusterRequest, opts ...grpc.CallOption) (*ClusterResponse, error) {
	out := new(ClusterResponse)
	err := c.cc.Invoke(ctx, "/service.CreateService/Installation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CreateService_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.CreateService/Check",
	}
...
func _CreateService_WriteFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.CreateService/WriteFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CreateService_Installation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.CreateService/Installation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
